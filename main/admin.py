...
from main.models import TelegramUser, TelegramUserIncome, TelegramAnswers, TelegramSupport, TelegramExpense
...
class TelegramSupportAdmin(admin.ModelAdmin):
    ...
    search_fields = [
        'user__user_id', 'user__username', 'user__firsta_name', 'user__last_name', 'message'
    ]
    readonly_fields = ['created_at']
    ordering = ['-created_at']
